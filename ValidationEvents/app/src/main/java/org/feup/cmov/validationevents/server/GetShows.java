...
public class GetShows extends ServerConnection implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            String serverURL = "http://" + address + ":" + port + "/shows?page=" + page + "&limit=" + limit;
            ...
            if (responseCode == Constants.OK_RESPONSE) {
                ...
                ArrayList<Show> shows = jsonToArray(response);
    ...
    private ArrayList<Show> jsonToArray(String jsonString) {
        ArrayList<Show> shows_list = new ArrayList<>();
